...
<!-- End of Sidebar -->
    ...
    <div class="content">
        <main>
            ...
            <!-- Toggle checkbox to display all details -->
            <input type="checkbox" id="showAllData">
            <label for="showAllData">Show All Data</label>
    ...
    <script>
        document.getElementById("usernameForm").addEventListener("submit", function (event) {
            ...
            var apiKey = "at_LBtOIAeU3lERWfSYge1qjxVRcLMBF"; // Replace with your API key
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    var html = "<h2>Whois Information for " + username + "</h2><ul>";

                    // Iterate over all properties in the returned JSON object
                    for (const key in data.WhoisRecord) {
                        if (data.WhoisRecord.hasOwnProperty(key)) {
                            const element = data.WhoisRecord[key];
                            html += "<li><strong>" + key + ":</strong> " + element + "</li>";
                        }
                    }
