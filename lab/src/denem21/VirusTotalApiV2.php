...
class VirusTotalAPIV2 {
	...
	public function scanFile($filePath) {
		...
		if (version_compare(PHP_VERSION, '5.3.0') >= 0) {
			...
			// For older PHP versions, sending the file without mime type or file name.
			$fileContent = file_get_contents($realPath);
			$parameters = array(
					'file' => $fileContent
				);
 ...
 *
 * @param object $report The report that's submission date should be returned.
 ...
 *
 * @param object $report The report that's total number of anti-virus checks should be returned.
 ...
 *
 * @param object $report The report that's number of anti-virus hits should be returned.
 ...
 *
 * @param object $report The report that's permalink should be returned.
