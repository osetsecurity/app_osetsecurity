...
// SQL sorgusu
$sql = "SELECT COUNT(*) AS total FROM `databasex`";
            ...
            <div class="header">
                <div class="left">
                    ...
                    <ul class="description">
                        <li><a href="#">
                            OSINTMixer is a project that brings together various OSINT tools that enable you to collect online intelligence quickly and effectively. This software includes various integrated tools to analyze different types of data and allow users to easily switch between tools.
                            </a>
                        </li>                        
                    </ul>
                </div>
            ...
            <ul class="details">
                ...
                <li><i class='bx bx-show-alt'></i>
                    <span class="info">
                        ...
                        <p>Bulunan  Hesaplar</p>
                    </span>
                </li>
                <li><i class='bx bx-search-alt'></i>
                    <span class="info">
                        <h3>
                            <?php echo $toplam_kayit_sayisi; ?>
                        </h3>
                        <p>Toplam Bulunan Hesaplar</p>
                    </span>
                </li>
            </ul>
            <!-- End of Details -->
            ...
            <div class="header">
                <div class="left">                    
                    <ul class="description">
                        ...
                        <li><a href="#">
                            OSINTMixer offers users a variety of OSINT tools. These tools include username checker, email checker, IP location checker, domain name checker and metadata checker. These tools enable users to analyze different types of data to gather online intelligence.
                            </a>
                        </li>                        
                    </ul>
                </div>
                    ...
                    <table>
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <p>IP - Location Checker</p>
                            </td>
                            <td>
                              <p>Domain Checker</p>
                            </td>
                            <td>
                              <p>Metadata Checker</p>
                            </td>
                          </tr>
                        </tbody>
                      </table>
